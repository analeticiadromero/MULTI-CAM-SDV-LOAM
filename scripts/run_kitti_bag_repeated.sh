...
RUNS=15
TAG="kitti09_multicam"
BAG_DIR="/media/analeticiaromero/ExtremeSSD/ANA/KITTI/09_oficial"
BAG_FILE="09.bag"
ROS_DISTRO_NAME="${ROS_DISTRO:-melodic}"
SDV_WS="$ROOT_DIR"
SDV_LAUNCH="run_kitti_09_multicam.launch"
OUTPUT_DIR="$ROOT_DIR/src/sdv_loam/output/kitti-09_multicam"
ARCHIVE_DIR=""
SDV_WARMUP_SEC=5
POST_BAG_WAIT_SEC=5
BAG_DELAY_SEC=1.0
...
Example:
  $0 --runs 15 --tag original_09 --bag-dir /media/analeticiaromero/ExtremeSSD/ANA/KITTI/09_oficial --bag-file 09.bag
EOF
}
...
for run_id in $(seq 1 "$RUNS"); do
    echo
    echo "========== KITTI bag multicam run ${run_id}/${RUNS} =========="
    SDV_PID=""
    BAG_PID=""
